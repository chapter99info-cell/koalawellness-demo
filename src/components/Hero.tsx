    ...
    <section id="home" className="relative min-h-[85vh] overflow-hidden pt-20">
      ...
      <div className="relative mx-auto flex min-h-[calc(85vh-5rem)] max-w-6xl items-center px-5 py-16 md:px-8 md:py-24">
        <FadeIn className="max-w-xl">
          <p className="mb-4 text-lg font-semibold uppercase tracking-widest text-sky-dark">
            Kirkstall · Great Ocean Road
          </p>
          <h1 className="text-5xl font-semibold leading-tight text-grey-dark md:text-7xl">
            Relax. Restore. Renew.
          </h1>
          <p className="mt-4 text-[22px] italic text-grey">{site.tagline}</p>

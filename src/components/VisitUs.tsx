      ...
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        <FadeIn className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-grey">
            Find us in the peaceful countryside of Kirkstall, a short drive from Port Fairy.
          </p>
        </FadeIn>
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-start">
          <FadeIn delay={80}>
            <div className="rounded-2xl bg-white p-7 shadow-sm md:p-8">
              <h3 className="text-2xl font-semibold text-grey-dark">Location &amp; Hours</h3>
